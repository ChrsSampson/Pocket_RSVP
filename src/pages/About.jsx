        ...
        <main className="flex flex-col text-black place-items-center py-4 bg-gradient-to-t from-navy-500 to-white">
            ...
            <section className="max-w-[90%] md:max-w-[80%] lg:min-w-[50%] pt-5 py-4">
                <Container>
                    <div className="flex justify-between place-items-center gap-10">
                        <button onClick={() => setExpand(!expand)} id="table-btn" className="px-5 py-4 bg-navy-500 hover:cursor-pointer text-white rounded-md">✚</button>
                        <h1>Table of Contents</h1>
                    </div>
                    { expand &&
                        <div className=" min-w-[50%]" id="table-container">
                            <Divider /> 
                            <div id="table" className='flex text-2xl flex-col text-left gap-6 md:min-w-[40%] lg:min-w-[50%]'>
            ...
            <section className="flex flex-col place-items-center gap-4 max-w-[90%] md:max-w-[80%] lg:max-w-[50%]">
                ...
                <Container id="dress">
                    ...
                    <Divider />
                    <p className="md:text-xl max-w-[70%]">Dress code for the event is Formal/Bussiness attire. The wedding party will be wearing navy and champagne. We would appriciate it if you would not wear those colors if you have not been instructed to.</p>
